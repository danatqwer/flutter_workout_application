...
class WorkoutItemIdRepositoryImpl extends WorkoutItemIdRepository {
  final WorkoutItemIdLocalDataSource _localStorage;

  WorkoutItemIdRepositoryImpl({
    required WorkoutItemIdLocalDataSource local,
  }) : _localStorage = local;
